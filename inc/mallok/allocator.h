...
#define AREA_TINY_SIZE (MIN_ALLOCATIONS_PER_AREA * AREA_TINY_MAX_ALLOCATION_SIZE)
#define AREA_SMALL_SIZE (MIN_ALLOCATIONS_PER_AREA * AREA_SMALL_MAX_ALLOCATION_SIZE)
